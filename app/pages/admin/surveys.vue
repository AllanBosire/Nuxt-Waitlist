<template>
  <UContainer class="py-8 space-y-8">
    ...
    <!-- Main Content Tabs -->
    <UTabs :items="tabItems" @update:modelValue="(t) => {selectedTab = t}">
    ...
    <!-- Analytics Modal -->
    <UModal v-model="showAnalyticsModal" :ui="{ wrapper: 'w-full max-w-7xl' }">
      <template #content>
        <UCard>
          <template #header>
...
const {data: surveysData, refresh} = await useFetch("/api/mattermost/surveys");
// Table configuration
