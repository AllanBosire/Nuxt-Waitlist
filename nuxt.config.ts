...
export default defineNuxtConfig({
    ...
    app: {
        head: {
            link: [
                { rel: "icon", type: "image/svg+xml", href: "/finueva.svg" },
            ],
        },
    },
    runtimeConfig: {
        ...
        mattermost: {
            ...
            bots: {
                ...
                moderator: {
                    token: "",
                    /** Comma separated list of channels that users are not allowed to send messages to */
                    noMessageChannels: "",
                    /** Comma separated list of channels that users are not allowed to send top level messages to */
                    noTopLevelMessageChannels: "",
                    /** Comma separated list of moderators */
                    persons: "",
                },
            },
